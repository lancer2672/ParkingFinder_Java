...
public class UserController {
    ...
    @Autowired
    private ParkingLotService pklService;
    @GetMapping("/{id}")
    ...
    @GetMapping("/parking-lots/{id}/staff")
    public ResponseTemplate<User> getStaffsByParkingLot(
            @PathVariable("id") Long parkingLotId,
            @RequestParam(name = "size", defaultValue = "10") int size,
            @RequestParam(name = "page", defaultValue = "0") int page) {
        Page<User> userPage = userService.getByParkingLotId(parkingLotId, size, page);
        return ResponseTemplate.success(userPage);
    }
    ...
    private User createUser(SignUpRequest signUpRequest) {
        ...
        if(signUpRequest.parkingLotId != null){
            ParkingLot pkl = pklService.getById(signUpRequest.parkingLotId);
            newUser.setParkingLot(pkl);
            newUser.setParkingLotId(signUpRequest.parkingLotId);
        }
